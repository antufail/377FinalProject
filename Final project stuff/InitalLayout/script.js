function getRandomInt(min, max) {
  ...
  function injectHTML(list) {
    ...
    const target = document.querySelector('#d_list')
    target.innerHTML='';
  ...
  */
  ...
  async function mainEvent() {
    ...
    */
    ...
    const textField = document.querySelector("#diabetes")
     ...
     */
    const results = await fetch('https://healthdata.gov/api/views/wwc6-um3r/rows.json?accessType=DOWNLOAD');
    ...
    */
    ...
    filterDataButton.addEventListener('click', (event) => { 
      ...
      const newList = filterList(arrayFromJson, formProps.diabetes);
      console.log(newList)
      injectHTML(newList);
    });
